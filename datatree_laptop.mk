...
main: histsetdata.o datatree.o ParTreeDataProcessing.C Hungarian.cpp
	g++ -o compiledThreadsData ParTreeDataProcessing.C -pthread -I /usr/include/boost `root-config --cflags --libs`

histsetdata.o: histsetdata.C datatree.o Hungarian.h PCToolsData.h PhotonCrossSections.h
	g++ -c -pthread  histsetdata.C -I /usr/include/boost `root-config --cflags --libs`
