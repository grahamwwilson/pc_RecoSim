...
xsfactor, region, nobs, ngam, mbt = radlenArgs.getArguments(None)
radlenArgs.showArgs(xsfactor, region, nobs, ngam, mbt)
...
radl = -(9.0/7.0)*(1.0/xsfactor)*math.log(1.0 - p)
dradl = (9.0/7.0)*(1.0/xsfactor)*dp/(1.0 - p)
