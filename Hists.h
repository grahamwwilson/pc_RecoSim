...
//init TH1D
 ...
 //   TH1Manager.at(id_eRnum_true_b2p5) = new MyTH1D("eRnum_true_b2p5","eff R numerator truth", customNbins,0,25);
	...
	TH1Manager.at(id_gflux_xsrSi) = new MyTH1D("gflux_xsrSi","Cross-section ratio (Si)",400,0.80,1.05);
	TH1Manager.at(id_gflux_xsrC) = new MyTH1D("gflux_xsrC","Cross-section ratio (C)",400,0.80,1.05);	
	TH1Manager.at(id_gflux_xsrBe) = new MyTH1D("gflux_xsrBe","Cross-section ratio (Be)",400,0.80,1.05);
	TH1Manager.at(id_gflux_xsrF) = new MyTH1D("gflux_xsrF","Cross-section ratio (F)",400,0.80,1.05);									
